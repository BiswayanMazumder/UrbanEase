...
export default function Homepagedetailsservicable() {
    ...
    return (
        <>
                            ...
                            <div className="dshfjdhksjdvd">
                                <div className="ehevfhgfjf">
                                    ...
                                    <div className="hegbehdbesf">
                                        ...
                                        <div className="dhjdbjdnj" onClick={() => setShowCleaningModal(true)}>
            ...
            {showCleaningModal && (
                <div className="cleaning-modal-overlay" onClick={() => setShowCleaningModal(false)}>

                    <div className="cleaning-modal-box" onClick={(e) => e.stopPropagation()}>

                        <span className="close-btn" onClick={() => setShowCleaningModal(false)}>×</span>

                        <h2 className="modal-heading">Cleaning</h2>

                        <div className="cleaning-options">

                            <div
                                className={`cleaning-option ${activeTab === 0 ? "active" : ""}`}
                                onMouseEnter={() => setActiveTab(0)} onClick={() => navigate("/bathroom-cleaning")}
                            >
                                <div className="icon-box">
                                    <img src="https://www.urbancompany.com/img?bucket=urbanclap-prod&quality=90&format=auto/w_64,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1777375035297-cfe32d.jpeg" />
                                </div>
                                <p>Bathroom Cleaning</p>
                            </div>

                            <div
                                className={`cleaning-option ${activeTab === 1 ? "active" : ""}`}
                                onMouseEnter={() => setActiveTab(1)}
                            >
                                <div className="icon-box">
                                    <img src="https://www.urbancompany.com/img?bucket=urbanclap-prod&quality=90&format=auto/w_64,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1776683772291-623cba.jpeg" />
                                </div>
                                <p>Kitchen Cleaning</p>
                            </div>

                            <div
                                className={`cleaning-option ${activeTab === 2 ? "active" : ""}`}
                                onMouseEnter={() => setActiveTab(2)}
                            >
                                <div className="icon-box">
                                    <img src="https://www.urbancompany.com/img?bucket=urbanclap-prod&quality=90&format=auto/w_64,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1776961154616-c17e54.jpeg" />
                                </div>
                                <p>Living & Bedroom Cleaning</p>
                            </div>

                            <div
                                className={`cleaning-option ${activeTab === 3 ? "active" : ""}`}
                                onMouseEnter={() => setActiveTab(3)}
                            >
                                <div className="icon-box">
                                    <img src="https://www.urbancompany.com/img?bucket=urbanclap-prod&quality=90&format=auto/w_64,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/supply/customer-app-supply/1776683767848-f79969.jpeg" />
                                </div>
                                <p>Full Home / By Room</p>
                            </div>
